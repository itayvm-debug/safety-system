...
export const FIELD_MAP = {
  ...
  // ── (ד) הצהרת הממנה ────────────────────────────────────────────────────────
  // שורת טקסט top:551, גובה פונט ~14px → תחתית הטקסט ~565
  // חתימה מתחילה ב-top:568 (3px מרווח מתחת לתחתית הטקסט)
  apDeclDate:        { top: 551, left:  382 },   // LTR — תאריך
  apDeclName:        { top: 551, right: 163 },
  apSig:             { top: 568, left:  137, w: 100, h: 30 },

  // ── (ה) הצהרת המפעיל ──────────────────────────────────────────────────────
  // שורת טקסט top:688, גובה פונט ~14px → תחתית הטקסט ~702
  // חתימה מתחילה ב-top:706 (4px מרווח מתחת לתחתית הטקסט)
