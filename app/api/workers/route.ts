...
export async function GET(request: NextRequest) {
  ...
  let query = supabase
    ...
    .select(managersOnly
      ...
      : subcontractorId
        ? 'id, full_name'
        : `*, documents(*), safety_briefings(*), height_restrictions(*), lifting_machine_appointments(id), manager_licenses(*), manager_insurances(*), vehicles(*, vehicle_licenses(*), vehicle_insurances(*)), subcontractor:subcontractors!workers_subcontractor_id_fkey(id, name)`)
    .order('full_name');
